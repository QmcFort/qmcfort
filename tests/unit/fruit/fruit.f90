...
contains
  ...
  function to_s_int8_ (value)
    implicit none
    character(len=500):: to_s_int8_
    integer(8), intent(in) :: value
    character(len=500) :: result
    write (result, *) value
    to_s_int8_ = adjustl(trim(result))
  end function to_s_int8_
...
module fruit
  ...
  !====== begin of generated interface ======
    ...
    module procedure assert_eq_int8_
    module procedure assert_eq_1d_int_
    module procedure assert_eq_1d_int8_
    module procedure assert_eq_2d_int_
    module procedure assert_eq_2d_int8_
    ...
    module procedure assert_eq_complex_sp_
    module procedure assert_eq_complex_sp_in_range_
    module procedure assert_eq_1d_complex_sp_
    module procedure assert_eq_1d_complex_sp_in_range_
    module procedure assert_eq_2d_complex_sp_
    module procedure assert_eq_2d_complex_sp_in_range_
...
contains
  subroutine test_set_summary(fname)
    character(len=*), intent(in) :: fname

    write(*,100)
    write(*,100) "Testing " // fname, " file is completed!"
    100 format (a,t70,a)
  end subroutine test_set_summary
...
999 continue
  ...
  !------ 0d_int8 ------
  subroutine assert_eq_int8_(var1, var2, message)

    integer(8), intent (in) :: var1, var2
    ...
    call add_success
  end subroutine assert_eq_int8_
  ...
  !------ 1d_int8 ------
  subroutine assert_eq_1d_int8_(var1, var2, n, message)
    integer, intent (in)    :: n
    integer                 :: i
    integer(8), intent (in) :: var1(n), var2(n)
    ...
    enddo
    call add_success
  end subroutine assert_eq_1d_int8_
  ...
  !------ 2d_int8 ------
  subroutine assert_eq_2d_int8_(var1, var2, n, m, message)
    integer, intent (in)    :: n, m
    integer                 :: i, j
    integer(8), intent (in) :: var1(n, m), var2(n, m)
    ...
    enddo
    call add_success
  end subroutine assert_eq_2d_int8_
...
&(aimag(var1(i, j)) > aimag(var2(i, j)))) then
  ...
  !------ 0d_complex ------
  subroutine assert_eq_complex_sp_(var1, var2, message)
...
&(aimag(var1) > aimag(var2))) then
    ...
    call add_success
  end subroutine assert_eq_complex_sp_

  !------ 0d_complex ------
  subroutine assert_eq_complex_sp_in_range_(var1, var2, delta, message)
    ...
    call add_success
  end subroutine assert_eq_complex_sp_in_range_

  !------ 1d_complex ------
  subroutine assert_eq_1d_complex_sp_(var1, var2, n, message)
    integer, intent (in) :: n
    integer              :: i
...
&(aimag(var1(i)) > aimag(var2(i)))) then
    ...
    enddo
    call add_success
  end subroutine assert_eq_1d_complex_sp_

  !------ 1d_complex ------
  subroutine assert_eq_1d_complex_sp_in_range_(var1, var2, n, delta, message)
    integer, intent (in) :: n
    integer              :: i
    complex, intent (in) :: var1(n), var2(n)
    real, intent (in) :: delta
    ...
    enddo
    call add_success
  end subroutine assert_eq_1d_complex_sp_in_range_

  !------ 2d_complex ------
  subroutine assert_eq_2d_complex_sp_(var1, var2, n, m, message)
    integer, intent (in) :: n, m
    integer              :: i, j
...
&(aimag(var1(i, j)) > aimag(var2(i, j)))) then
    ...
    enddo
    call add_success
  end subroutine assert_eq_2d_complex_sp_

  !------ 2d_complex ------
  subroutine assert_eq_2d_complex_sp_in_range_(var1, var2, n, m, delta, message)
    integer, intent (in) :: n, m
    integer              :: i, j
    complex, intent (in) :: var1(n, m), var2(n, m)
    real, intent (in) :: delta
    ...
    enddo
    call add_success
  end subroutine assert_eq_2d_complex_sp_in_range_
